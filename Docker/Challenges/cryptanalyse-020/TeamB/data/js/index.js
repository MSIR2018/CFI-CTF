...
mhnUI = {
    ...
    lock: function() {
        mhnUI.page.hide(), pattern = new PatternLock(".mhn-lock", {
            margin: 15
        }), $(".mhn-lock-title").html($(".mhn-lock-title").data("title")), pattern.removeAfterCreate(atob("Nzg0OTUxNjIz"), function() { $(".patt-holder").addClass("patt-success"), setTimeout(function() {
            pattern.reset(), alert(atob("RmVsaWNpdGF0aW9u"));
        }, 1e3)
